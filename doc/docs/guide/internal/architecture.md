...
Le compilateur Althread est décrit en détail dans la section Compilateur. Il faut noté que le compilateur n'effectue aucune optimisation, il se contente de traduire le programme en instructions.