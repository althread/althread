...
export default function App() {
	...
	const [stdoutWarning, setStdoutWarning] = createSignal<string | null>(null);
						...
						<button
							...
							onClick={async () => {
								...
								try {
									...
									if (res.path.length > 0) {
										const replay = buildCounterexampleReplay(
											res.path,
											res.nodes,
										);
