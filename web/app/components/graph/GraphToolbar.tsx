	...
	return (
		<div class="graph-toolbar">
			<button
				type="button"
				title={
					props.isFullscreen ? "Exit Fullscreen (Esc, F)" : "Fullscreen (F)"
				}
			...
			<button type="button" title="Recenter" onClick={props.onRecenter}>
				<i class="codicon codicon-record"></i>
			</button>

			<div class="download-dropdown" style={{ position: "relative" }}>
				<button type="button" title="Download" onClick={handleDownloadClick}>
			...
			<button type="button" title="Details" onClick={props.onDetails}>
