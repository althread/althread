...
import {
	...
	createCustomSyntaxHighlighting,
} from "./custom-style";
	...
	return EditorView.theme(
		{
			...
			"&.cm-focused .cm-selectionBackground, .cm-selectionBackground": {
				backgroundColor: isDark
					? "rgba(38, 79, 120, 0.70) !important"
					: "rgba(245, 184, 96, 0.38) !important",
			},
			".cm-selectionLayer": {
				mixBlendMode: "normal",
			},
			...
			".cm-selectionMatch": {
				backgroundColor: isDark
					...
					: "rgba(209, 136, 38, 0.16)",
				borderRadius: "2px",
			},
			".cm-selectionMatch.cm-selectionMatch-main": {
				backgroundColor: isDark
					? "rgba(38, 79, 120, 0.30)"
					: "rgba(214, 156, 75, 0.22)",
			},
			".cm-foldGutter": {
				width: "16px",
				paddingLeft: "2px",
...
const createEditor = ({
	...
	editor.createExtension(
		syntaxCompartment.of(createCustomSyntaxHighlighting(theme)),
	);
				...
				view.dispatch({
					effects: [
						...
						syntaxCompartment.reconfigure(
							createCustomSyntaxHighlighting(nextTheme),
						),
					],
				});
				return true;
