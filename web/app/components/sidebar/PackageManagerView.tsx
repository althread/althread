				...
				<div class="package-manager-actions">
					...
					<Show when={altTomlConfig()}>
						<button
							...
							disabled={
								loading() ||
								Object.keys(altTomlConfig()?.dependencies || {}).length === 0
							}
							class="header-action-btn"
						>
			...
			<div class="package-manager-content">
				...
				<Show when={error()}>
					<div class="error-message">
						...
						<span>{error()}</span>
						<button class="close-msg" onClick={clearMessages}>
							×
						</button>
					</div>
				</Show>
						...
						<div class="project-header">
							...
							<div class="project-details">
								...
								<div class="project-version">
									v{altTomlConfig()?.package.version}
								</div>
							</div>
						</div>
					</div>
					...
					<div class="dependencies-section">
						<div class="dependencies-section-header">
							<div class="section-header">
								...
								<h4>
									Dependencies (
									{Object.keys(altTomlConfig()?.dependencies || {}).length})
								</h4>
							</div>
						</div>

						<Show
							when={Object.keys(altTomlConfig()?.dependencies || {}).length > 0}
						>
							<div class="dependencies-install-hint">
								<i class="codicon codicon-info"></i>
								<span>
									Click "Install All" in the header to download and install all
									dependencies.
								</span>
							</div>
