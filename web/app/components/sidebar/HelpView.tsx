					...
					<div class="help-links">
						<button class="help-link" onClick={() => setShowExamples(true)}>
							...
							<div>
								...
								<div class="help-link-desc">
									Explore sample programs and code examples
								</div>
							</div>
						</button>
						...
						<button
							...
							onClick={() =>
								window.open(
									"https://althread.github.io/en/docs/guide/intro/",
									"_blank",
								)
							}
						>
						...
						<button
							...
							onClick={() =>
								window.open(
									"https://github.com/althread/althread/issues/new?template=🐞-bug-report.md",
									"_blank",
								)
							}
						>
