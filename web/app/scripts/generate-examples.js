...
function extractMetadata(content, fileName) {
	...
	if (tagsMatch) {
		...
		if (content.includes("channel "))
			autoTags.push("channels", "communication");
		...
		if (content.includes("send ") || content.includes("receive "))
			autoTags.push("messaging");
		if (content.includes("recursive")) autoTags.push("recursion");
		if (content.includes("fibonacci"))
			autoTags.push("fibonacci", "math", "algorithms");
		if (content.includes("peterson"))
			autoTags.push("peterson", "mutex", "critical-section");
